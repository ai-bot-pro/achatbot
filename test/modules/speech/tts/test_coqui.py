...
from src.modules.speech.tts.coqui_tts import EngineClass

r"""
python -m unittest test.modules.speech.tts.test_coqui.TestCoquiTTS.test_inference
"""
...
class TestCoquiTTS(unittest.TestCase):
    ...
    def test_inference(self):
        ...
        self.session.ctx.tts_stream = bool(self.stream)
