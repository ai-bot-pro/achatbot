#!/usr/bin/env python
"""
from: https://websockets.readthedocs.io/en/stable/intro/tutorial3.html
"""
...
async def play(websocket: WebSocketServerProtocol, game: Connect4, player, connected: Iterable[WebSocketCommonProtocol]):
    """
