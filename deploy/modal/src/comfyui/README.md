...
python deploy/modal/src/comfyui/client.py --modal-workspace $(modal profile current) --prompt "Surreal dreamscape with floating islands, upside-down waterfalls, and impossible geometric structures, all bathed in a soft, ethereal light" --size 1280x720 --steps 6 --dev --type video --model video_fastvideo_hunyuan_diffusers
