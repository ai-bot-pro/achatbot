...
vita_audio_img = (
    ...
    .run_commands(
        ...
        "cd /VITA-Audio && git checkout f1735b598b29a4009702db2fbcc0aeca4f59c908",
    )
    .env(
        {
            "DDP_BACKEND": "nccl",
...
with vita_audio_img.imports():
    ...
    OUTPUT_DIR = os.path.join(TRAIN_OUTPUT_DIR, f"{TRAIN_NAME}_{cur_date}")
...
"""
# just debug | 1xA100 for 7B with zero 1/2 (乱马)
modal run src/train/vita_audio/finetune_glm4voice_stage1.py

# run train with test data | 1xH100 for 7B with ds zero 1/2 (乱马)
IMAGE_GPU=H100 MAX_STEPS=2 modal run src/train/vita_audio/finetune_glm4voice_stage1.py
"""
