...
class DailyAsrStepVoiceBot(DailyRoomBot):
    """
    - use daily audio stream(bytes) --> asr --> text ---> Step voice processor --> tts -->text/audio_bytes
    - TODO: use daily audio stream(bytes) --> asr --> text ---> Step voice processor -->text/audio_bytes
    """
    ...
    async def arun(self):
        ...
        self._voice_processor = self.get_text_step_voice_processor()
