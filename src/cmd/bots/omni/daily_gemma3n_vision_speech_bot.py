...
class DailyGemma3nVisionSpeechBot(DailyRoomBot):
    """
    use daily images + audio stream(bytes) --> Gemma3n vision speech processor -->text/audio_bytes
    """
    ...
    async def arun(self):
        ...
        self._vision_speech_processor = self.get_gemma3n_vision_speech_processor()
