...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path_or_size', "-m", type=str,
                        default="./models/openai/whisper-base", help='model path or size')
    parser.add_argument('--lang', "-l", type=str,
                        default="zh", help='target language')
    args = parser.parse_args()
    pipe_whisper_transcribe(
        args.audio_path, args.model_path_or_size, args.lang)
