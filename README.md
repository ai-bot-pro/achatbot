...
| [daily_annotate_vision_bot](https://github.com/ai-bot-pro/achatbot/blob/main/src/cmd/bots/vision/daily_annotate_vision_bot.py) | e.g.:<br />daily_room_audio_stream,<br />vision_yolo_detector<br />tts_edge |                                                              | T4(free)                                                     | e.g.:<br />daily room in stream<br />vision_yolo_detector<br />-> edge (tts)<br />-> daily room out stream |
|                                                              |                                                              |                                                              |                                                              |                                                              |
|                                                              |                                                              |                                                              |                                                              |                                                              |
