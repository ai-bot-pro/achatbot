...
class ADKSupervisorAgent(ADKBaseHostAgent):
...
"""
LOG_LEVEL=debug python -m src.services.a2a_multiagents.adk_supervisor_agent
python -m src.services.a2a_multiagents.adk_supervisor_agent
"""
