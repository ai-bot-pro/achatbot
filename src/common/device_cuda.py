    ...
    def __init__(self, verbose=True):
        ...
        for i in range(nGpus.value):
            ...
            if (
                ...
                self.verbose and print("  GPU clock: %g MHz" % (clockrate.value / 1000.0))
            if (
                cuda.cuDeviceGetAttribute(
                ...
                self.verbose and print("  Memory clock: %g MHz" % (clockrate.value / 1000.0))
            try:
            ...
            if result != CUDA_SUCCESS:
                ...
                if result == CUDA_SUCCESS:
                    self.verbose and print("  Total Memory: %ld MiB" % (totalMem.value / 1024**2))
