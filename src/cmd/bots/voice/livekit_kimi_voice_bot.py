...
class LivekitKimiVoiceBot(LivekitRoomBot):
    """
    use livekit audio stream(bytes) --> kimi audio voice processor -->text/audio_bytes
    ...
    async def arun(self):
        ...
        self._voice_processor = self.get_audio_kimi_voice_processor()
