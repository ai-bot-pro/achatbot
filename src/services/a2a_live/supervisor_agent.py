...
from src.services.a2a_multiagents import BaseHostAgent, convert_parts


class SupervisorLiveAgent(BaseHostAgent):
    f"""
...
"""
LOG_LEVEL=debug python -m src.services.a2a_live.supervisor_agent
python -m src.services.a2a_live.supervisor_agent
"""
if __name__ == "__main__":
    ...
    async def arun():
        ...
        host_agent = SupervisorLiveAgent(
            ["http://0.0.0.0:6666"],
            http_client_wrapper(),
