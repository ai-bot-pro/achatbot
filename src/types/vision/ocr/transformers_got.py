...
class TransformersGoTOCRArgs:
    ...
    model_type: str = field(
        default="chat",
        metadata={
            "help": "Model type, chat, chat_crop. Default is chat."
        },
    )
    ocr_type: str = field(
        default="ocr",
        metadata={
            "help": "OCR type, ocr,format. Default is ocr."
        },
    )
    ocr_box: str = field(
        default="",
    ...
    render: bool = field(
        default=False,
        metadata={
            "help": "Whether to render to file, Default is false."
        },
    )
    save_render_file: str = field(
        default="",
        metadata={
            "help": "when render is true, to save file path, Default is empty str."
        },
    )
