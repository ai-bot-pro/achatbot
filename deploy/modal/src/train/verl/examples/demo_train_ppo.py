...
img = (
    ...
    .run_commands(
        ...
        "cd /verl && git checkout a6b2ed97614f6e70188cfe590369ae27c4b20510 && pip install -q .",
    )
)
...
def run(other_args: str = "", total_epochs: int = 2, retrain: bool = False, strategy: str = "fsdp"):
    import torch
