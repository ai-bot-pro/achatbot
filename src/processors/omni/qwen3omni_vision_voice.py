...
from src.core.llm.transformers.manual_vision_voice_qwen3 import (
    TransformersManualVisionVoiceQwen3OmniLLM,
)
...
class Qwen3OmnVisionVoiceProcessor(VisionVoiceProcessorBase):
    """ """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            llm=llm or TransformersManualVisionVoiceQwen3OmniLLM(**kwargs),
            session=session,
            **kwargs,
        )
    ...
    def stream_info(self) -> dict:
        ...
        return {
            "sample_rate": TransformersManualVisionVoiceQwen3OmniLLM.RATE,
            "channels": 1,
        }
