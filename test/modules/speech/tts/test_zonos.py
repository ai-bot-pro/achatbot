...
python -m unittest test.modules.speech.tts.test_zonos.TestZonosTTS.test_synthesize_speak
...
class TestZonosTTS(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.tts_tag = os.getenv("TTS_TAG", "tts_zonos")
