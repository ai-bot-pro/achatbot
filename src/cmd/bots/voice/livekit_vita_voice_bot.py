...
class LivekitVITAVoiceBot(LivekitRoomBot):
    """
    use livekit audio stream(bytes) --> vita audio voice processor -->text/audio_bytes
    ...
    async def arun(self):
        ...
        self._voice_processor = self.get_audio_vita_voice_processor()
